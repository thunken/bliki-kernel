...
To add a dependency on this project using Gradle, Maven, sbt, or Leiningen, we recommend using [JitPack](https://jitpack.io/#thunken/bliki-kernel/1.0.3). The Maven group ID is `com.github.thunken`, and the artifact ID is `bliki-kernel`.
