...
/**
 * Manages user data from the <a href="https://meta.wikimedia.org/w/api.php">Wikimedia API</a>.
 *
 * See also <a href="https://www.mediawiki.org/wiki/API:Login">Mediawiki API:Login</a>
 */
public class User {
	 ...
	 *
	 * @return <code>true</code> if th login was successful; <code>false</code> otherwise.
