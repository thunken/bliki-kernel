 ...
 *
 * Example: <a
 * href="https://en.wikipedia.org/w/api.php?action=opensearch&amp;search=Te">api.php?action=opensearch&amp;search=Te</a>
 *
 *
 */
public class OpenSearch extends RequestBuilder {
	...
	/**
	 * namespace - a Namespace to search<br/>
	...
	/**
	 * namespace - Namespaces to search<br/>
