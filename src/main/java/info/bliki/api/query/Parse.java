...
/**
 * Module Parse <b> action=parse </b>.<br/>
 * Parses wikitext pages and returns parser output
 *
 * Example: <a href="https://en.wikipedia.org/w/api.php?action=parse">api.php ?action=parse</a>
 *
 */
public class Parse extends RequestBuilder {
	 ...
	 * Values (separate with '|'): text, langlinks, categories, links, templates, images, externallinks, sections,
	 * revid, displaytitle Default:
	 * text|langlinks|categories|links|templates|images|externallinks|sections|revid|displaytitle<br/>
	 *
	 * @param props
	 * @return
	 */
