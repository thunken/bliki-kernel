 ...
 * on the Query API interface currently available on all MediaWiki servers. All data modifications will first have to
 * use query to acquire a token to prevent abuse from malicious sites.
 *
 * <pre>
 * Parameters:
 ...
 *
 * Example: <a
 * href="https://en.wikipedia.org/w/api.php?action=query&amp;prop=revisions&amp;meta=siteinfo&amp;titles=Main%20Page&amp;rvprop=user%7Ccomment"
 * >api.php?action=query&amp;prop=revisions&amp;meta=siteinfo&amp;titles=Main%20 Page&amp;rvprop=user|comment</a>
 *
 *
 *
 */
public class Query extends RequestBuilder {
	...
	/**
	 * Which property to get for the titles/revisions/pageids.<br/>
	 * Values info, revisions, links, langlinks, images, imageinfo, templates, categories, extlinks, categoryinfo,
	 * duplicatefiles
	 *
	 * @param prop
	 * @return
	...
	/**
	 * Which properties to get for the titles/revisions/pageids.<br/>
	 * Values (internally separated with '|'): info, revisions, links, langlinks, images, imageinfo, templates,
	 * categories, extlinks, categoryinfo, duplicatefiles
	 *
	 * @param prop
	 * @return
	 */
	...
	/**
	 * Which meta data to get about the site.<br/>
	 * Values (separate with '|'): siteinfo, userinfo, allmessages
	 *
	 * @param metadata
	 * @return
	 ...
	 * backlinks, categorymembers, embeddedin, imageusage, search, watchlist, exturlusage, random
	 *
	 * @param generator
	 * @return
	 */
	...
	/**
	 * Which additional property to get:<br/>
	 * "protection" - List the protection level of each page "talkid" - The page ID of the talk page for each non-talk
	 * page "subjectid" - The page ID of the parent page for each talk page Values (separate with '|'): protection,
	 * talkid, subjectid, url, readable
	 *
	 * @param prop
	 * @return
	 */
	...
	/**
	 * Which additional properties to get: "protection" - List the protection level of each page "talkid" - The page ID
	 * of the talk page for each non-talk page "subjectid" - The page ID of the parent page for each talk page Values
	 * (separate with '|'): protection, talkid, subjectid, url, readable
	 *
	 * @param prop
	 * @return
	 */
