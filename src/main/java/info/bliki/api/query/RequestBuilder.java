...
public class RequestBuilder {
	...
	/**
	 * The format of the output One value: json, jsonfm, php, phpfm, wddx, wddxfm, xml, xmlfm, yaml, yamlfm, rawfm, txt,
	 * txtfm, dbg, dbgfm Default: xmlfm
	 *
	 * @param lType
	 * @return
	 */
	...
	/**
	 * What action you would like to perform One value: sitematrix, opensearch, login, logout, query, expandtemplates,
	 * parse, feedwatchlist, help, paraminfo, purge, rollback, delete, undelete, protect, block, unblock, move, edit,
	 * emailuser, watch, patrol Default: help
	 *
	 * @param lType
	 * @return
	 */
