 ...
 *
 * <p>
 * Domain names are evaluated according to the standards <a href="https://www.ietf.org/rfc/rfc1034.txt">RFC1034</a>,
 * section 3, and <a href="https://www.ietf.org/rfc/rfc1123.txt">RFC1123</a>, section 2.1. No accomodation is provided
 * for the specialized needs of other applications; if the domain name has been URL-encoded, for example, validation
 * will fail even though the equivalent plaintext version of the same name would have passed.
 * </p>
 *
 * <p>
 * Validation is also provided for top-level domains (TLDs) as defined and maintained by the Internet Assigned Numbers
 * Authority (IANA):
 * </p>
 *
 * <ul>
 ...
 *
 * <p>
 * (<b>NOTE</b>: This class does not provide IP address lookup for domain names or methods to ensure that a given domain
 * name matches a specific IP; see {@link java.net.InetAddress} for that functionality.)
 * </p>
 *
