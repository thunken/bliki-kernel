...
public interface HTMLTag {
	 ...
	 *            the converter which contains the special wiki tag conversion rules.
	 * @param node
	 *            the current HTML node which should be converted to HTML
	 * @param resultBuffer
	 *            the resulting HTML buffer
	 * @param showWithoutTag
	 *            if <code>true</code> don't call the open() and close() method for this tag
	 */
	void emptyContent(AbstractHTMLToWiki html2WikiConverter, TagNode node, StringBuilder resultBuffer,
	 ...
	 *            if <code>true</code> don't call the open() and close() method for this tag
	 */
	void content(AbstractHTMLToWiki html2WikiConverter, TagNode node, StringBuilder resultBuffer,
			boolean showWithoutTag);
