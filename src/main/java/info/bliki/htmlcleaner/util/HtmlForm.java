 ...
 *
 * Sources adopted from the article
 * <a href="https://www.javaworld.com/javaworld/jw-08-2008/jw-08-java-wiki-extensions.html">Add Java extensions to your
 * wiki</a> with permission from Randall Scarberry.
 *
 * @author R.Scarberry
 *
 */
public class HtmlForm {
	 ...
	 *
	 * @param id
	 *            element id, which is usually the same as the name when both are supplied.
	 * @param name
	...
	public static class ElementAttribute {
		...
		public boolean equals(Object o) {
			...
			if (o instanceof ElementAttribute) {
				...
				return this.mName.equals(other.mName) && this.mType.equals(other.mType)
