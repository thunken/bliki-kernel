...
public class Siteinfo {
	...
	/**
	 * Get the namespace of this site from the given integer key. For example in an english Mediawiki installation
	 * <i>10</i> is typically the <i>Template</i> namespace and <i>14</i> is typically the <i>Category</i> namespace.
	 *
	 * @param key
	...
	/**
	 * Get the integer value of this site from the given namespace. For example in an english Mediawiki installation
	 * <i>10</i> is typically the <i>Template</i> namespace and <i>14</i> is typically the <i>Category</i> namespace.
	 *
	 * @param namespace
	 * @return <code>null</code> if no integer value is defined for the given namespace.
	 */
	@Nullable
	...
	/**
	 * Get the character case of the wiki. For example <i>first-letter</i> is set, if the first letter of a wiki title
	 * is converted to an upper case letter.
	 *
