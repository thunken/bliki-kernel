...
public class WikiArticle {
	...
	/**
	 * Get the integer key of the namespace or <code>0</code> if no namespace is associated. For example in an english
	 * Mediawiki installation <i>10</i> is typically the <i>Template</i> namespace and <i>14</i> is typically the
