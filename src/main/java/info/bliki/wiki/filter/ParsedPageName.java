 ...
 *
 * Note that {@link #magicWord} takes precedence over {@link #pagename}, i.e. if {@link #magicWord} if not
 * <tt>null</tt>, the parsed name is a magic word!
 *
...
public class ParsedPageName {
	 ...
	 *
	 * The object type depends on the concrete {@link MagicWord} implementation used by the
	 * {@link info.bliki.wiki.model.IWikiModel}, e.g. {@link info.bliki.wiki.filter.MagicWord.MagicWordE} in case
	 ...
	 *            the name of the page (without the namespace)
	 * @param magicWord
	 *            the magic word object if the pagename was a magic word, otherwise <tt>null</tt>
	 * @param magicWordParameter
	 *            parameters of the magic word (<tt>null</tt> if not supplied)
	 * @param valid
	 *            whether this pagename was successfully parsed or not
	 */
	public ParsedPageName(INamespace.INamespaceValue namespace, String pagename, Object magicWord,
			String magicWordParameter, boolean valid) {
		this.namespace = namespace;
		this.pagename = pagename;
		this.valid = valid;
	...
	/**
	 * Parses a given page name into its components, e.g. namespace and pagename or magic word and parameters.
	 *
	 * @param wikiModel
	 ...
	 * @param namespace
	 *            the default namespace to use if there is no namespace in the pagename
	 * @param magicWordAllowed
	 *            whether the <tt>pagename</tt> may be a magic word or not (if it is a magic word and this is set to
	 *            <tt>false</tt>, it will be parsed as if it is a page name)
	 *
	 * @return a parsed page name
	 */
	@Nonnull
	public static ParsedPageName parsePageName(@Nonnull IWikiModel wikiModel, @Nonnull String pagename,
	...
	public String toString() {
		return "ParsedPageName{" + "namespace=" + namespace + ", pagename='" + pagename + '\'' + '}';
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(valid, pageName.valid) && Objects.equals(namespace, pageName.namespace)
				&& Objects.equals(pagename, pageName.pagename) && Objects.equals(magicWord, pageName.magicWord)
