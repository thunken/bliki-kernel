...
public class Util {
	...
	/**
	 * Returns the index within the searchable string of the first occurrence of the concatenated <i>start</i> and
	 * <i>end</i> substring. The end substring is matched ignoring case considerations.
	 *
	 ...
	 *         specified index.
	 */
	public static int indexOfIgnoreCase(String searchableString, String startPattern, String endPattern,
			int fromIndex) {
	...
	/**
	 * Returns the nested index within the searchable string of the first occurrence of <code>&lt;</code> and the
	 * <i>end</i> string. The end string is matched ignoring case considerations.
	 *
	 * @param searchableString
	 *            the searchable string
	 * @param endPattern
	...
	/**
	 * Trim whitespace characters from the left and right side of the string, until we find a non whitespace character
	 * or a new line character on the righ side. Delete the first newline found on the right side of the string.
	 *
	 * @param str
	 * @return
	 */
	...
	/**
	 * Get the first position of the <code>rawWikitext</code> string, which contains a character requiring template
	 * parsing.
	 *
	 * @param rawWikitext
	 *            the raw wiki text
	 * @return <code>-1</code> if character is found, which requires template parsing.
	 */
