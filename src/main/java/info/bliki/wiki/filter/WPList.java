...
/**
 * Represents a Wikipedia list. See
 * <a href="https://meta.wikimedia.org/wiki/Help:List" >https://meta.wikimedia.org/wiki/Help:List</a>
 *
...
public class WPList extends WPTag implements PlainTextConvertable {
	...
	private void renderSubListPlainText(InternalList list, ITextConverter converter, Appendable buf,
