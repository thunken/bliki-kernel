...
public class Configuration implements IConfiguration {
	...
	static {
		...
		final Enumeration<Object> eKeys = mapping.keys();

		while (eKeys.hasMoreElements()) {
			final String key = (String) eKeys.nextElement();
	...
	/**
	 * Tries to avoid page breaks inside tables, e.g. for printouts (disable to get more MediaWiki-compliant HTML code).
	 *
	 * Note: Only supported by Opera, according to https://www.w3schools.com/cssref/pr_print_pagebi.asp
	 */
	...
	public Configuration(final String wikiId, final Casing casing) {
	 ...
	 * See <a href="https://en.wikipedia.org/wiki/URI_scheme">URI scheme</a>
	 *
	 * @return <code>true</code> if the set did not already contain the specified URI key.
	 */
	public boolean addUriScheme(final String uriKey) {
