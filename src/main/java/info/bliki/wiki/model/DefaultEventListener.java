...
/**
 * A default wiki event listener implementation which will trigger the <code>on....</code> event methods during the
 * parsing process.
 *
 * This listener does nothing useful, but implementing wrappers for the interface methods.
 *
 */
