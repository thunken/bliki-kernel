...
/**
 * A wiki event listener which will trigger the <code>on....</code> event methods during the parsing process.
 *
 */
public interface IEventListener {
	 ...
	 * @param endPosition
	 *            the end offset of the wiki head including the wiki head end tags + 1.
	 * @param rawStart
	 ...
	 * @param level
	 *            the header level (i.e. <code>==</code> gives level 2; <code>===</code> gives level 3;<code>====</code>
	 *            gives level 4...)
	 */
	 ...
	 *            the currently parsed raw wikitext character array
	 * @param rawStart
	 *            the start offset of the wiki link excluding the wiki link start tags '[['
	 * @param rawEnd
	 *            the end offset of the wiki link excluding the wiki link end tags ']]'
	 * @param suffix
	 *            a suffix string eventually written directly behind the wiki link (useful for plurals).
	 *
	 *            Example:
	 *
	 *            <pre>
	 ...
	 *            the currently parsed raw wikitext character array
	 * @param rawStart
	 *            the start offset of the wiki link excluding the wiki template start tags '{{'
	 * @param rawEnd
	 *            the end offset of the wiki link excluding the wiki template end tags '}}'
	 */
