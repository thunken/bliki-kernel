 ...
 *
 * Copied from Patch #1488331 sf.net user: o_rossmueller; modified by axelclk http
 * ://sourceforge.net/tracker/index.php?func=detail&aid=1488331&group_id= 128886 &atid=713150
 *
 */
public class ImageFormat {
			...
			for (int j = 1; j < list.size(); j++) {
				...
				if (caption.length() > 0) {
					...
					if (defIndex > 0) {
						...
						if (token.equals("right") || token.equals("left") || token.equals("center")
								|| token.equals("none")) {
	...
	/**
	 * Set the size of the image in pixel. If the given string ends with "px" additionally calculate the integer value
	 * of the width and optionally the size of the height (example: "600px"). If the size is negative ignore it.
	 *
	 * See <a href="https://en.wikipedia.org/wiki/Image_markup#Size">Image markup#Size</a> and See
	...
	/**
	 * Set the width of the image in pixel. This method is typically used to set a &quot;default width&quot; (220px) for
	 * images of type &quot;thumb&quot; if no width is set in the image format string.
	 *
	 * @param width
