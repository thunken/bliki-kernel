...
public class Namespace implements INamespace {
	/**
	 * Maps namespaces case-insensitively to their according {@link NamespaceValue} objects.
	 */
	 ...
	 */
	public final NamespaceValue PROJECT_TALK = new NamespaceValue(PROJECT_TALK_NAMESPACE_KEY, "Project_talk",
			"Meta_talk");
	/**
	...
	/**
	 * NS_IMAGE and NS_IMAGE_TALK are the pre-v1.14 names for NS_FILE and NS_FILE_TALK respectively, and are kept for
	 * compatibility.
	 */
	...
	private void extractFromResource(ResourceBundle resourceBundle, String ns1Id, String ns2Id, NamespaceCode code,
			ExtractType cmd) {
	...
	protected void extractFromResource(ResourceBundle resource, ExtractType cmd) {
		...
		extractFromResource(resource, Messages.WIKI_API_SPECIAL1, Messages.WIKI_API_SPECIAL2, SPECIAL_NAMESPACE_KEY,
				cmd);
		...
		extractFromResource(resource, Messages.WIKI_API_USERTALK1, Messages.WIKI_API_USERTALK2, USER_TALK_NAMESPACE_KEY,
				cmd);
		extractFromResource(resource, Messages.WIKI_API_META1, Messages.WIKI_API_META2, PROJECT_NAMESPACE_KEY, cmd);
		extractFromResource(resource, Messages.WIKI_API_METATALK1, Messages.WIKI_API_METATALK2,
		...
		extractFromResource(resource, Messages.WIKI_API_IMAGETALK1, Messages.WIKI_API_IMAGETALK2,
				FILE_TALK_NAMESPACE_KEY, cmd);
		extractFromResource(resource, Messages.WIKI_API_MEDIAWIKI1, Messages.WIKI_API_MEDIAWIKI2,
		...
		extractFromResource(resource, Messages.WIKI_API_TEMPLATE1, Messages.WIKI_API_TEMPLATE2, TEMPLATE_NAMESPACE_KEY,
				cmd);
		extractFromResource(resource, Messages.WIKI_API_TEMPLATETALK1, Messages.WIKI_API_TEMPLATETALK2,
		...
		extractFromResource(resource, Messages.WIKI_API_HELPTALK1, Messages.WIKI_API_HELPTALK2, HELP_TALK_NAMESPACE_KEY,
				cmd);
		extractFromResource(resource, Messages.WIKI_API_CATEGORY1, Messages.WIKI_API_CATEGORY2, CATEGORY_NAMESPACE_KEY,
				cmd);
		extractFromResource(resource, Messages.WIKI_API_CATEGORYTALK1, Messages.WIKI_API_CATEGORYTALK2,
		...
		extractFromResource(resource, Messages.WIKI_API_PORTALTALK1, Messages.WIKI_API_PORTALTALK2,
		...
		extractFromResource(resource, Messages.WIKI_API_MODULETALK1, Messages.WIKI_API_MODULETALK2,
				MODULE_TALK_NAMESPACE_KEY, cmd);
	}
	...
	@Override
	public String[] splitNsTitle(String fullTitle, boolean underScoreIsWhitespace, char whiteSpaceChar,
			boolean firstCharacterAsUpperCase) {
		int colonIndex = fullTitle.indexOf(':');
		if (colonIndex != (-1)) {
			String maybeNs = Encoder.normaliseTitle(fullTitle.substring(0, colonIndex), underScoreIsWhitespace,
					whiteSpaceChar, firstCharacterAsUpperCase);
			if (getNamespace(maybeNs) != null) {
				// this is a real namespace
				return new String[] { maybeNs, Encoder.normaliseTitle(fullTitle.substring(colonIndex + 1),
		...
		return new String[] { "",
				Encoder.normaliseTitle(fullTitle, underScoreIsWhitespace, whiteSpaceChar, firstCharacterAsUpperCase) };
	}
