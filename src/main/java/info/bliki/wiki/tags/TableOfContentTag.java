...
/**
 * Wiki tag for rendering the &quot;table of contents&quot inside a wikipedia article
 *
 */
	...
	private void renderToC(Appendable writer, List<Object> toc, int level) throws IOException {
		...
		for (Object tocItem : toc) {
			if (tocItem instanceof SectionHeader) {
				...
				writer.append("\n<li class=\"toclevel-").append(Integer.toString(level)).append("\"><a href=\"#")
						.append(anchor).append("\">").append(head).append("</a>");
				setLI = true;
			} else {
