...
public class ABAPCodeFilter extends AbstractCodeFormatter {
	...
	private static final String[] KEYWORDS = { "ADD", "ALL", "AND", "ANY", "ADD-CORRESPONDING", "APPEND", "APPENDING",
			"ASSIGN", "ASSIGNED", "ASSIGNING", "AT", "AUTHORITY-CHECK", "BACK", "BEGIN", "BETWEEN", "BINARY",
			"BREAK-POINT", "BY", "CALL", "CASE", "CHANGING", "CHECK", "CLEAR", "CLOSE", "CA", "CN", "CO", "CP", "CS",
			"CNT", "COLLECT", "COMMIT", "COMMUNICATION", "COMPUTE", "CONCATENATE", "CONDENSE", "CONSTANTS", "CONTINUE",
			"CONTROLS", "CONVERT", "CORRESPONDING", "COUNT", "CUSTOMER-FUNCTION", "CREATE", "CURRENCY", "CURSOR",
			"DATA", "DEFINE", "DELETE", "DESCRIBE", "DETAIL", "DIVIDE", "DIVIDE-CORRESPONDING", "DO", "EDIT",
			"EDITOR-CALL", "ELSE", "ELSEIF", "END", "END-OF-DEFINITION", "END-OF-PAGE", "END-OF-SELECTION", "ENDAT",
			"ENDCASE", "ENDDO", "ENDEXEC", "ENDFORM", "ENDFUNCTION", "ENDIF", "ENDIFEND", "ENDLOOP", "ENDMODULE",
			"ENDON", "ENDPROVIDE", "ENDSELECT", "ENDWHILE", "ENTRIES", "EQ", "EXCEPTIONS", "EXEC", "EXIT",
			"EXIT FROM STEP LOOP", "EXPORT", "EXPORTING", "EXTRACT", "FETCH", "FIELD", "FIELD-GROUPS", "FIELD-SYMBOLS",
			"FIELDS", "FOR", "FORM", "FORMAT", "FREE", "FROM", "FUNCTION", "FUNCTION-POOL", "GENERATE", "GET", "GE",
			"GT", "HIDE", "ID", "INITIAL", "IF", "IS", "IMPORT", "IMPORTING", "INCLUDE", "INFOTYPES", "INPUT", "IN",
			"INITIALIZATION", "INPUT", "INSERT", "INTO", "KEY", "LE", "LEAVE", "LIKE", "LINE", "LOAD", "LOCAL", "LOOP",
			"LT", "M", "MASK", "MEMORY", "METHOD", "MESSAGE", "MODIFY", "MODULE", "MOVE", "MOVE-CORRESPONDING",
			"MULTIPLY", "MULTIPLY-CORRESPONDING", "NA", "NP", "NS", "NE", "NEW-LINE", "NEW-PAGE", "NEW-SECTION", "NO",
			"NOT", "O", "OF", "ON", "OR", "OUTPUT", "OVERLAY", "PACK", "PARAMETER", "PARAMETERS", "PERFORM", "POSITION",
			"PRINT-CONTROL", "PROGRAM", "PROVIDE", "PUT", "RAISE", "RANGES", "READ", "RECEIVE", "REF", "REFRESH",
			"REJECT", "REPLACE", "REPORT", "REQUESTED", "RESERVE", "RESTORE", "ROLLBACK", "ROWS", "SCAN", "SCREEN",
			"SCROLL", "SEARCH", "SELECT", "SELECT-OPTIONS", "SELECTION-SCREEN", "SEPARATED", "SET", "SHIFT", "SINGLE",
			"SKIP", "SORT", "SPACE", "SPLIT", "START-OF-SELECTION", "STATICS", "STOP", "STRUCTURE", "SUBMIT",
			"SUBTRACT", "SUBTRACT-CORRESPONDING", "SUM", "SUMMARY", "SUPPRESS", "SYNTAX-CHECK", "SYNTAX-TRACE", "TABLE",
			"TABLES", "TIMES", "TO", "TOP-OF-PAGE", "TRANSACTION", "TRANSFER", "TRANSLATE", "TRANSPORTING", "TYPE",
			"TYPE-POOL", "TYPE-POOLS", "TYPES", "ULINE", "USING", "UNPACK", "UP", "UPDATE", "VALUE", "WHEN", "WHILE",
			"WINDOW", "WAIT", "WHERE", "WITH", "WORK", "WRITE", "Z" };
		...
		try {
			while (true) {
				...
				if ((currentChar >= 'A' && currentChar <= 'Z') || (currentChar >= 'a' && currentChar <= 'z')) {
					...
					currentPosition = appendIdentifier(input, identStart, currentPosition, keywordsSet, objectsSet,
							result);
					identFound = false;
					continue; // while loop
