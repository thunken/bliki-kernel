...
abstract public class AbstractCPPBasedCodeFilter extends AbstractCodeFormatter {
	...
	protected int appendIdentifier(String input, int identifierStart, int currentPosition,
			HashMap<String, String> keyWords, HashMap<String, String> objectWords, StringBuilder result) {
	...
	/**
	 * Test if the keywords are case sensitive. Returns <code>true</code> by default.
	 *
