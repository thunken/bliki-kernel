...
public class PythonCodeFilter extends AbstractCPPBasedCodeFilter implements SourceCodeFormatter {
	...
	private static final String[] KEYWORDS = { "False", "None", "True", "and", "as", "assert", "class", "break",
			"continue", "def", "del", "else", "elif", "except", "finally", "for", "from", "global", "is", "import",
			"in", "if", "lambda", "nonlocal", "not", "or", "pass", "raise", "return", "try", "with", "while", "yield" };

	private static final String[] OBJECT_WORDS = {
			// see https://docs.python.org/library/functions.html
			"abs", "all", "any", "basestring", "bin", "bool", "callable", "chr", "classmethod", "cmp", "compile",
			...
			"isinstance", "issubclass", "iter", "len", "list", "locals", "long", "map", "max", "min", "next", "object",
			"oct", "open", "ord", "pow", "print", "property", "range", "raw", "reduce", "reload", "repr", "reversed",
			"round", "set", "setattr", "slice", "sorted", "staticmethod", "str", "sum", "super", "tuple", "type",
			"unichr", "unicode", "vars", "xrange", "zip", "__import__", "apply", "buffer", "coerce", "intern" };
