...
/**
 * Wiki tag for the <a href="https://code.google.com/apis/chart/">Google Chart API</a>
 *
 */
public class ChartTag extends HTMLTag implements INoBodyParsingTag {
	...
	/**
	 * See <a href= "https://code.google.com/intl/de-DE/apis/chart/docs/chart_params.html">chart parameters supported by
	 * the Google Chart API</a>.
	 */
	final static public String[] ALLOWED_ATTRIBUTES = { "alt", "chbh", "chco", "chd", "chdl", "chdlp", "chds", "chem",
			"chf", "chfd", "chg", "chl", "chld", "chls", "chm", "chma", "choe", "chof", "chp", "chs", "chst", "cht",
			"chtm", "chtt", "chts", "chxt", "chxr", "chxl", "chxp", "chxs", "chxtc" };
