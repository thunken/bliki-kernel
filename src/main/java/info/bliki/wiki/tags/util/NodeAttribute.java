 ...
 * <code>Page</code> by providing the page and cursor offsets into the page for the name and value. This is done for
 * speed, since if the name and value are not needed we can avoid the cost and memory overhead of creating the strings.
 * <p>
 * Thus the property getters, defer to the base class unless the property is null, in which case an attempt is made to
 * read it from the underlying page. Optimizations in the predicates and length calculation defer the actual
...
public class NodeAttribute extends Attribute {
	...
	/**
	 * The starting offset of the name within the page. If negative, the name is considered <code>null</code>.
	 */
	...
	/**
	 * The starting offset of the value within the page. If negative, the value is considered <code>null</code>.
	 */
	 ...
	 *
	 * @param name_start
	 *            The starting offset of the name within the page. If this is negative, the name is considered null.
	 * @param name_end
	 *            The ending offset of the name within the page.
	 * @param value_start
	 *            he starting offset of the value within the page. If this is negative, the value is considered null.
	 * @param value_end
	 *            The ending offset of the value within the page.
	 * @param quote
	 *            The quote, if any, surrounding the value of the attribute, (i.e. ' or "), or zero if none.
	 */
	...
	/**
	 * Create an attribute with the name, assignment string, value and quote given. If the quote value is zero, assigns
	 * the value using {@link #setRawValue} which sets the quote character to a proper value if necessary.
	 *
	 * @param name
	 ...
	 *                {@link #PageAttribute(String,String)}.
	 */
