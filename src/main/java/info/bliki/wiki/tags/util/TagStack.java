...
public class TagStack extends ArrayList<TagToken> {
	...
	/**
	 * Looks at the <code>TagToken</code> at the top of this stack without removing it from the stack.
	 *
	...
	/**
	 * Removes the <code>TagToken</code> at the top of this stack and returns that <code>TagToken</code>.
	 *
