...
/**
 * A template parser function for <code>{{nse: ... }}</code> <i>namespace/i> syntax
 *
 ...
 * German) would not.
 *
 * {{nse:}} is the equivalent encoded for MediaWiki URLs. It does the same, but it replaces spaces with underscores,
 * making it usable in external links.
 */
