...
/**
 * A template parser function for <code>{{titleparts: ... }}</code>. This function separates a pagetitle into segments
 * based on slashes, then returns some of those segments as output. See
 * <a href= "https://www.mediawiki.org/wiki/Help:Extension:ParserFunctions#.23titleparts" >Mediawiki -
 * Help:Extension:ParserFunctions - Titleparts</a>
 *
 */
