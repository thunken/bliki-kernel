...
/**
 * A list of <code>ASTNode</code>'s which represents a parsed function.<br/s> The head of the function (i.e. Ceil,
 * Floor, Trunc, Plus, Times,...) is stored in the 0-th index of the list.<br/>
