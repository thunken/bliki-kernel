...
public class XMLPagesParserTest {
	@Test
	public void testParsePageParsesTitleCorrectly() throws Exception {
	...
	@Test
	public void testParseValidPageParsesDoesNotHaveInvalidFlagSet() throws Exception {
		XMLPagesParser parser = new XMLPagesParser(xml("fooPage"));
		parser.parse();
	...
	@Test
	public void testParseValidPageParsesDoesNotHaveMissingFlagSet() throws Exception {
		XMLPagesParser parser = new XMLPagesParser(xml("fooPage"));
		parser.parse();
	...
	@Test
	public void testParseParsesMissingPageCorrectly() throws Exception {
	...
	@Test
	public void testParseParsesInvalidPageCorrectly() throws Exception {
	...
	@Test
	public void testParsePageWithWarnings() throws Exception {
