...
public abstract class BaseQueryTest {
	...
	/**
	 * Define <code>DEFAULT_USER</code> and <code>DEFAULT_PASSWORD</code> with a correct user/password and modify the
	 * <code>ParseTest#testParseRegisteredQuery()</code> JUnit method to test your user.
	 *
	 * @return
