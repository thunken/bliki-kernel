...
public class ParseTest extends BaseQueryTest {
	...
	public void test001() {
		...
		assertThat(request.toString()).isEqualTo(
				"action=parse&amp;format=xml&amp;text={{Project:Sandbox}}&amp;title=A Sandbox Template test");
	}

	/**
	 * To make this test work correctly uncomment it and be sure that you have a internet connection running.
	 */
	...
	/**
	 * To make this test work correctly uncomment it and the <code>assertNotNull(user);</code> line and define a correct
	 * user in the <code>getRegisteredUser()</code> method
	 *
