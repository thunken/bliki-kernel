...
/**
 * Demo application which reads a compressed or uncompressed Wikipedia XML dump file (depending on the given file
 * extension <i>.gz</i>, <i>.bz2</i> or <i>.xml</i>) and prints the title and wiki text.
 *
 */
public class DumpExample {
	...
	/**
	 * Print all titles of the wiki pages which have &quot;Real&quot; content (i.e. the title has no namespace prefix)
	 * (key == 0).
	 */
	...
	/**
	 * @param args
	 *            filename, e.g. dewikiversity-20100401-pages-articles.xml.bz2
	 */
