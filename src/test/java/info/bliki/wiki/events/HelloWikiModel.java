...
/**
 * Wiki model implementation which allows some special JUnit tests with predefined templates
 *
 * Uses a modified template from:
 * <a href="https://en.wikipedia.org/wiki/Template:Reflist" >https://en.wikipedia.org/wiki/Template:Reflist</a>
 */
