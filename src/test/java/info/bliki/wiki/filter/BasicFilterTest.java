...
public class BasicFilterTest extends FilterTestSupport {
	...
	public void testIssue149() throws Exception {
		assertThat(wikiModel.render("mit '''db2 connect to <db>''' mit der Datenbank v", false))
	 ...
	 */
	@Test
	public void testIssue135b() throws Exception {
	 ...
	 */
	@Test
	public void testLiNoUl01() throws Exception {
		assertThat(wikiModel.render("<li>test1\n<li>test2", false))
				.isEqualTo("\n" + "<ul>\n" + "\n" + "<li>test1</li>\n" + "<li>test2</li>\n" + "</ul>");
	}
	 ...
	 */
	@Test
	public void testEmptyTags001() throws Exception {
	 ...
	 */
	@Test
	public void testEmptyTags002() throws Exception {
	 ...
	 */
	@Test
	public void testEmptyTags003() throws Exception {
	 ...
	 */
	@Test
	public void testEmptyTags004() throws Exception {
	...
	public void testParagraph1() throws Exception {
		assertThat(wikiModel.render("This is a simple paragraph.", false))
				.isEqualTo("\n" + "<p>This is a simple paragraph.</p>");
	}

	@Test
	public void testParagraph2() throws Exception {
		assertThat(wikiModel.render("This is a simple paragraph.\n\nA second paragraph.", false))
	...
	@Test
	public void testNOTOC() throws Exception {
		assertThat(wikiModel.render("jhfksd __NOTOC__ sflkjsd", false)).isEqualTo("\n" + "<p>jhfksd  sflkjsd</p>");
	}

	@Test
	public void testWrongNOTOC() throws Exception {
	...
	public void testbq3() throws Exception {
		assertThat(wikiModel.render("<blockquote>start blockquote here\n" + "\n" + "line above me\n"
				...
				+ "end of blockquote here</blockquote> ", false))
						.isEqualTo("<blockquote>start blockquote here\n" + "\n" + "<p>line above me\n"
	...
	@Test
	public void testNestedPreBlock() throws Exception {
		assertThat(wikiModel.render("{|border=1 width=\"79%\"\n" + "!wikitext\n" + "|-\n" + "|\n"
	...
	@Test
	public void testPBlock() throws Exception {
		assertThat(wikiModel.render(
	...
	@Test
	public void testALink001() throws Exception {
		assertThat(wikiModel.render("<a href=\"http://www.test.com\">Test2</a>", false))
				.isEqualTo("\n" + "<p><a href=\"http://www.test.com\" rel=\"nofollow\">Test2</a></p>");
	}

	@Test
	public void testXSS001() throws Exception {
		assertThat(wikiModel.render("<h1 onmouseover=\"javascript:alert(\'yo\')\">Test</h1>", false))
				.isEqualTo("<h1>Test</h1>");
	}

	@Test
	public void testSignature01() throws Exception {
		assertThat(wikiModel.render("a simple~~~~test", false)).isEqualTo("\n" + "<p>a simple~~~~test</p>");
	}

	@Test
	public void testSignature02() throws Exception {
		assertThat(wikiModel.render("a simple~~~~", false)).isEqualTo("\n" + "<p>a simple~~~~</p>");
	}

	@Test
	public void testSignature03() throws Exception {
		assertThat(wikiModel.render("a simple~~~~~test", false)).isEqualTo("\n" + "<p>a simple~~~~~test</p>");
	}

	@Test
	public void testSignature04() throws Exception {
		assertThat(wikiModel.render("a simple~~~~~", false)).isEqualTo("\n" + "<p>a simple~~~~~</p>");
	}

	@Test
	public void testSignature05() throws Exception {
		assertThat(wikiModel.render("a simple~~~test", false)).isEqualTo("\n" + "<p>a simple~~~test</p>");
	}

	@Test
	public void testSignature06() throws Exception {
		assertThat(wikiModel.render("a simple~~~", false)).isEqualTo("\n" + "<p>a simple~~~</p>");
	}

	@Test
	public void testSignature07() throws Exception {
		assertThat(wikiModel.render("~~~test", false)).isEqualTo("\n" + "<p>~~~test</p>");
	}

	@Test
	public void testSignature08() throws Exception {
		assertThat(wikiModel.render("~~~", false)).isEqualTo("\n" + "<p>~~~</p>");
	}

	@Test
	public void testSpan001() throws Exception {
	...
	@Test
	public void testReuseModel001() throws Exception {
		wikiModel.setUp();
		try {
			assertThat(wikiModel.render("= My Title 1=\n" + "__TOC__\n" + "== secA ==", false))
					.isEqualTo("<h1><span class=\"mw-headline\" id=\"My_Title_1\">My Title 1</span></h1>\n"
		...
		wikiModel.setUp();
		try {
			assertThat(wikiModel.render("= My Title 2=\n" + "__TOC__\n" + "== secB ==", false))
					.isEqualTo("<h1><span class=\"mw-headline\" id=\"My_Title_2\">My Title 2</span></h1>\n"
							+ "<table id=\"toc\" class=\"toc\" summary=\"Contents\">\n" + "<tr>\n" + "<td>\n"
							+ "<div id=\"toctitle\">\n" + "<h2>Contents</h2>\n" + "</div>\n" + "<ul>\n"
	...
	@Test
	public void testAbbr01() throws Exception {
		assertThat(wikiModel.render("<abbr title=\"test\">[?]</abbr>", false))
				.isEqualTo("\n" + "<p>" + "<abbr title=\"test\">[?]</abbr></p>");
	}

	@Test
	public void testAbbr02() throws Exception {
		assertThat(wikiModel.render("<abbr title=\"<nowiki>test</nowiki>\">[?]</abbr>", false))
				.isEqualTo("\n" + "<p>" + "<abbr title=\"test\">[?]</abbr></p>");
	}

	@Test
	public void testIFrame01() throws Exception {
		assertThat(wikiModel.render(
				...
				false)).isEqualTo(
						"<iframe height=\"180\" name=\"inlineframe\" src=\"float.html\" width=\"500\"> </iframe>");
	}
