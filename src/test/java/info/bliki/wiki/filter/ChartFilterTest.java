...
public class ChartFilterTest extends FilterTestSupport {
	...
	@Test
	public void testChart001() throws Exception {
		assertThat(wikiModel.render("<chart \n" + "  cht=bvs \n" + "  chs=800x300 \n" + "  chbh=20,1 \n"
				+ "  chxt=x,y \n" + "  chco=76A4FB \n" + "  chls=2.0   "
	...
	@Test
	public void testChart002() throws Exception {
		// TeX formula
		assertThat(wikiModel.render("<chart cht=tx chl=\"x = \\frac{-b \\pm \\sqrt {b^2-4ac}}{2a}\" />", false))
				.isEqualTo("\n"
