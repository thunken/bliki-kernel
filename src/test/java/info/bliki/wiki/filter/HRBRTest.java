...
public class HRBRTest extends FilterTestSupport {
	...
	@Test
	public void testHR01() throws Exception {
		assertThat(wikiModel.render("\n----\ntest", false)).isEqualTo("<hr />\n" + "<p>test</p>");
	}

	@Test
	public void testHR02() throws Exception {
		assertThat(wikiModel.render("\n<blockquote>\n----\ntest\n</blockquote>", false))
				.isEqualTo("<blockquote><hr />\n" + "<p>test\n" + "</p>\n</blockquote>");
	}

	@Test
	public void testHR03() throws Exception {
		assertThat(wikiModel.render("\n------  \ntest", false)).isEqualTo("<hr />\n" + "<p>test</p>");
	}

	@Test
	public void testHR04() throws Exception {
