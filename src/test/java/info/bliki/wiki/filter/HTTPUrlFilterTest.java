...
public class HTTPUrlFilterTest extends FilterTestSupport {
	...
	public void testIssue90() throws Exception {
		assertThat(wikiModel.render("start [http://www.google.com] middle [http://www.google.de] end", false))
				.isEqualTo("\n"
	...
	@Test
	public void testIssue90a() throws Exception {
		assertThat(wikiModel
				.render("start [  http://www.google.com Google] middle [\nhttp://www.google.de Google DE] end", false))
						.isEqualTo("\n"
	...
	@Test
	public void testIssue90b() throws Exception {
		assertThat(wikiModel.render("start [www.google.de Google DE ] end", false))
	...
	@Test
	public void testUrlHTTP001() throws Exception {
	...
	public void testISBN() throws Exception {
		assertThat(wikiModel.render(
				"Note that the numbers are not automatically made clickable until they are in this format:\n" + "\n"
						+ ":ISBN 1413304540\n" + "\n"
	...
	@Test
	public void testMailto001() throws Exception {
	...
	@Test
	public void testMailto002() throws Exception {
		assertThat(wikiModel.render("Linking to an e-mail address works the same way: \n"
				+ "maILto:someone@domain.com or \n" + "[mAilTo:someone@domain.com someone]", false)).isEqualTo("\n"
						+ "<p>Linking to an e-mail address works the same way: \n"
						+ "<a class=\"external free\" href=\"maILto:someone@domain.com\" rel=\"nofollow\" title=\"maILto:someone@domain.com\">maILto:someone@domain.com</a> or \n"
	...
	@Test
	public void testMailto003() throws Exception {
		assertThat(wikiModel.render(
	...
	@Test
	public void testWrongMailto() throws Exception {
		assertThat(wikiModel.render("Linking to an e-mail address works the same way: \n"
	...
	@Test
	public void testWrongMailto2() throws Exception {
	...
	@Test
	public void testUrlWithSpan() throws Exception {
		assertThat(wikiModel.render(
	...
	@Test
	public void testUrlTEL01() throws Exception {
		assertThat(wikiModel.render("call tel:+0815-4711", false)).isEqualTo("\n"
				+ "<p>call <a class=\"telephonelink\" href=\"tel:+0815-4711\" title=\"tel:+0815-4711\">tel:+0815-4711</a></p>");
	}

	@Test
	public void testUrlTEL02() throws Exception {
		assertThat(wikiModel.render("call [tel:+0815-4711 a phone number]", false)).isEqualTo("\n"
				+ "<p>call <a class=\"telephonelink\" href=\"tel:+0815-4711\" title=\"tel:+0815-4711\">a phone number</a></p>");
	}

	@Test
	public void testUrlTEL03() throws Exception {
		assertThat(wikiModel.render("call [tEl:+0815-4711 a phone number]", false)).isEqualTo("\n"
				+ "<p>call <a class=\"telephonelink\" href=\"tEl:+0815-4711\" title=\"tEl:+0815-4711\">a phone number</a></p>");
	}
}
