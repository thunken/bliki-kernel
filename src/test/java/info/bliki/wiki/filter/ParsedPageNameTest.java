...
public class ParsedPageNameTest extends FilterTestSupport {
	...
	@Test
	public void testParsePageNameWithNamespace() throws Exception {
	...
	@Test
	public void testParsePageNameWithNamespaceArgument() throws Exception {
		ParsedPageName name = ParsedPageName.parsePageName(wikiModel, "foo", wikiModel.getNamespace().getModule(),
				false, false);
		assertThat(name.fullPagename()).isEqualTo("Module:foo");
	}

	@Test
	public void testParsePageNameWithNamespaceArgumentAlreadyContainingNamespace() throws Exception {
		ParsedPageName name = ParsedPageName.parsePageName(wikiModel, "Module:foo",
				wikiModel.getNamespace().getModule(), false, false);
		assertThat(name.fullPagename()).isEqualTo("Module:foo");
	}

	@Test
	public void testParsePageWithEmptyStringParsesAsEmpty() throws Exception {
	...
	public void testParsePageWithNullThrowsNullPointerException() throws Exception {
