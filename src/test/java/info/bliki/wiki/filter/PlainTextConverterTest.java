...
public class PlainTextConverterTest extends FilterTestSupport {
	...
	@Test
	public void testConvertSingleNode() throws Exception {
		PTag pTag = new PTag();
	...
	@Test
	public void testConvertLinkThroughModel() throws Exception {
		assertThat(wikiModel.render(plainTextConverter, "[[foo]]", false)).isEqualTo("\nfoo");
	}

	@Test
	public void testConvertSentenceEndingWithPeriod() throws Exception {
		assertThat(wikiModel.render(plainTextConverter, "Foo Bar.", false)).isEqualTo("\nFoo Bar.");
	}

	@Test
	public void testConvertLinkWithTitleThroughModel() throws Exception {
	...
	@Test
	public void testConvertBold() throws Exception {
		assertThat(wikiModel.render(plainTextConverter, "This is '''bold'''", false)).isEqualTo("\nThis is bold");
	}

	@Test
	public void testConvertBoldItalic() throws Exception {
		assertThat(wikiModel.render(plainTextConverter, "This is '''''bold italic'''''", false))
				.isEqualTo("\nThis is bold italic");
	}

	@Test
	public void testConvertAnchoredLinkThroughModel() throws Exception {
		assertThat(wikiModel.render(plainTextConverter, "[[foo#anchored]]", false)).isEqualTo("\nfoo#anchored");
	}

	@Test
	public void testConvertLinkThroughModelWithRenderLinks() throws Exception {
		plainTextConverter = new PlainTextConverter(true);
		assertThat(wikiModel.render(plainTextConverter, "[[foo]]", false)).isEqualTo("\nfoo");
	}

	@Test
	public void testConvertLinkWithTitleThroughModelWithRenderLinks() throws Exception {
		plainTextConverter = new PlainTextConverter(true);
		assertThat(wikiModel.render(plainTextConverter, "[[foo|other text]]", false)).isEqualTo("\nother text");
	}

	@Test
	public void testConvertLinkWithAnchorThroughModelWithRenderLinks() throws Exception {
		plainTextConverter = new PlainTextConverter(true);
		assertThat(wikiModel.render(plainTextConverter, "[[foo#anchor]]", false)).isEqualTo("\nfoo#anchor");
	}

	@Test
	public void testConvertLinkWithPrecedingDashThroughModelWithRenderLinks() throws Exception {
		plainTextConverter = new PlainTextConverter(true);
		assertThat(wikiModel.render(plainTextConverter, "-[[foo]]", false)).isEqualTo("\n-foo");
	}

	@Test
	public void testConvertPipeLink() throws Exception {
		assertThat(wikiModel.render(plainTextConverter, "[[#English|headword]]", false)).isEqualTo("\nheadword");
	}

	@Test
	public void testConvertHorizontalRule() throws Exception {
		plainTextConverter = new PlainTextConverter(true);
		assertThat(wikiModel.render(plainTextConverter, "----\n", false)).isEqualTo("");
	}

	@Test
	public void testRefTagsGetFilteredOut() throws Exception {
		plainTextConverter = new PlainTextConverter(true);
		assertThat(wikiModel.render(plainTextConverter, "foo<ref>bar</ref>baz", false)).isEqualTo("\nfoobaz");
	}

	@Test
	public void testConvertLinkNode() throws Exception {
