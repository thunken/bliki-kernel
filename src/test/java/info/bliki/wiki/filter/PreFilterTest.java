...
public class PreFilterTest extends FilterTestSupport {
	...
	public void testPre4() throws Exception {
		assertThat(wikiModel.render("== Peanut Butter (variant 1) ==\n"
				+ " [[Image:PeanutButter.jpg|thumb|\"Smooth\" peanut butter in a jar]]", false)).isEqualTo(
						"<h2><span class=\"mw-headline\" id=\"Peanut_Butter_.28variant_1.29\">Peanut Butter (variant 1)</span></h2>\n"
	...
	public void testPre5() throws Exception {
		assertThat(wikiModel.render("== Peanut Butter (variant 2) ==\n" + " test0\n"
				...
				+ "'''Peanut butter''' is a food paste made primarily from ...", false)).isEqualTo(
						"<h2><span class=\"mw-headline\" id=\"Peanut_Butter_.28variant_2.29\">Peanut Butter (variant 2)</span></h2>\n"
								+ "<pre>" + "test0\n" + "\n" + "</pre>\n" + "<div class=\"thumb tright\">\n"
								+ "<div class=\"thumbinner\" style=\"width:222px;\"><a class=\"internal\" href=\"http://www.bliki.info/wiki/Image:PeanutButter.jpg\" title=\"&#34;Smooth&#34; peanut butter in a jar\"><img src=\"http://www.bliki.info/wiki/PeanutButter.jpg\" alt=\"&#34;Smooth&#34; peanut butter in a jar\" title=\"&#34;Smooth&#34; peanut butter in a jar\" class=\"type-thumb\" width=\"220\" />\n"
								+ "</a>\n"
								+ "<div class=\"thumbcaption\">&#34;Smooth&#34; peanut butter in a jar</div></div>\n"
	...
	public void testPre6() throws Exception {
		assertThat(wikiModel.render("== Peanut Butter (variant 3) ==\n" + " test0\n"
				...
				+ "'''Peanut butter''' is a food paste made primarily from ...", false)).isEqualTo(
						"<h2><span class=\"mw-headline\" id=\"Peanut_Butter_.28variant_3.29\">Peanut Butter (variant 3)</span></h2>\n"
								+ "<pre>" + "test0\n" + "\n" + "</pre>\n" + "<p>test</p>\n"
								+ "<div class=\"thumb tright\">\n"
								+ "<div class=\"thumbinner\" style=\"width:222px;\"><a class=\"internal\" href=\"http://www.bliki.info/wiki/Image:PeanutButter.jpg\" title=\"&#34;Smooth&#34; peanut butter in a jar\"><img src=\"http://www.bliki.info/wiki/PeanutButter.jpg\" alt=\"&#34;Smooth&#34; peanut butter in a jar\" title=\"&#34;Smooth&#34; peanut butter in a jar\" class=\"type-thumb\" width=\"220\" />\n"
								+ "</a>\n"
	...
	public void testPre7() throws Exception {
		assertThat(wikiModel.render("== TestLBPre ==\n" + " test1\n" + "\n" + " test2", false))
				.isEqualTo("<h2><span class=\"mw-headline\" id=\"TestLBPre\">TestLBPre</span></h2>\n" + "<pre>"
						+ "test1\n" + "</pre>\n" + "<pre>" + "test2\n" + "</pre>");
	}
	 ...
	 */
	@Test
	public void testPre8() throws Exception {
		assertThat(wikiModel.render("== TestLBPre ==\n" + " test1\n" + " \n" + " test2", false))
				.isEqualTo("<h2><span class=\"mw-headline\" id=\"TestLBPre\">TestLBPre</span></h2>\n" + "<pre>"
						+ "test1\n" + "\n" + "test2\n" + "</pre>");
	}
	...
	@Test
	public void testPre0() throws Exception {
	...
	@Test
	public void testPre10() throws Exception {
		assertThat(wikiModel.render(
