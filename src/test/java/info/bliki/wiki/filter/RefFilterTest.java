...
public class RefFilterTest extends FilterTestSupport {
	...
	@Test
	public void testRef01() throws Exception {
		assertThat(wikiModel.render("A <ref>Reference</ref> Test\n\n<references/>", false)).isEqualTo("\n"
	...
	@Test
	public void testRef03() throws Exception {
		assertThat(wikiModel.render("aaa <ref name=\"Freitag\"/> bbb<ref name=\"Arndt\"/> <ref>ccc</ref> <references/>",
				false)).isEqualTo("\n"
	...
	public void testRef04() throws Exception {
		assertThat(wikiModel.render(
				"aaa <ref name=Freitag></ref> bbb<ref    name=Arndt>arn</ref> <ref>ccc</ref> <references/>", false))
						.isEqualTo("\n"
								+ "<p>aaa <sup id=\"_ref-Freitag\" class=\"reference\"><a href=\"#_note-Freitag\" title=\"\">[1]</a></sup> bbb<sup id=\"_ref-Arndt\" class=\"reference\"><a href=\"#_note-Arndt\" title=\"\">[2]</a></sup> <sup id=\"_ref-3\" class=\"reference\"><a href=\"#_note-3\" title=\"\">[3]</a></sup> </p><ol class=\"references\">\n"
	...
	@Test
	public void testRef05() throws Exception {
		assertThat(wikiModel.render("aaa <ref name=Freitag/> bbb<ref name=Arndt /> <ref>ccc</ref> <references/>",
				false)).isEqualTo("\n"
						+ "<p>aaa <sup id=\"_ref-Freitag\" class=\"reference\"><a href=\"#_note-Freitag\" title=\"\">[1]</a></sup> bbb<sup id=\"_ref-Arndt\" class=\"reference\"><a href=\"#_note-Arndt\" title=\"\">[2]</a></sup> <sup id=\"_ref-3\" class=\"reference\"><a href=\"#_note-3\" title=\"\">[3]</a></sup> </p><ol class=\"references\">\n"
						+ "<li id=\"_note-Freitag\"><b><a href=\"#_ref-Freitag\" title=\"\">&#8593;</a></b> </li><li id=\"_note-Arndt\"><b><a href=\"#_ref-Arndt\" title=\"\">&#8593;</a></b> </li><li id=\"_note-3\"><b><a href=\"#_ref-3\" title=\"\">&#8593;</a></b> ccc</li>\n</ol>");
	...
	@Test
	public void testRef06() throws Exception {
	...
	@Test
	public void testRef07() throws Exception {
		assertThat(wikiModel.render(
				"<ref>{{cite book |last=Malins|first=Steve|title=Depeche Mode: A Biography|year=2001|publisher=Andre Deutsch|chapter=|pages=82|isbn=978-0233994307}}</ref>\n\n\n<references/>",
				false)).isEqualTo("\n"
	...
	@Test
	public void testRef08() throws Exception {
