...
public class TOCFilterTest extends FilterTestSupport {
	...
	@Test
	public void testTOC01() throws Exception {
		assertThat(wikiModel.render("{| align=\"right\" \n" + "| __TOC__ \n" + "|}\n" + "\n" + "==hello world 2==\n"
				+ "hello world 2\n" + "\n" + "===hello world3===\n" + "hello world 3", false))
	...
	@Test
	public void testTOC02() throws Exception {
		assertThat(wikiModel.render("{| align=\"right\"\n" + "| __TOC__\n" + "|}\n" + "\n" + "=hello world 1=\n"
				+ "hello world 1\n" + "\n" + "==hello world 2==\n" + "hello world 2\n" + "\n" + "==hello world1a==\n"
				+ "hello world 1a\n" + "", false))
						.isEqualTo("\n" + "<div style=\"page-break-inside: avoid;\">\n" + "<table align=\"right\">\n"
	...
	@Test
	public void testTOC03() throws Exception {
		assertThat(wikiModel.render(
				"=hello world 1=\n" + "hello world 1\n" + "\n" + "==hello world 2==\n" + "hello world 2\n", false))
						.isEqualTo("<h1><span class=\"mw-headline\" id=\"hello_world_1\">hello world 1</span></h1>\n"
								+ "<p>hello world 1</p>\n"
								+ "<h2><span class=\"mw-headline\" id=\"hello_world_2\">hello world 2</span></h2>\n"
								+ "<p>hello world 2\n" + "</p>");
	}
	...
	@Test
	public void testTOC04() throws Exception {
		assertThat(wikiModel.render(
				"=hello world 1=\n" + "hello world 1\n" + "\n" + "==hello world 2==\n" + "hello world 2\n" + "\n"
						+ "==hello world 3==\n" + "hello world 3\n" + "===hello world 4===\n" + "hello world 4\n",
				false)).isEqualTo(
	...
	@Test
	public void testTOC05() throws Exception {
	...
	@Test
	public void testTOC06() throws Exception {
	...
	@Test
	public void testTOC07() throws Exception {
		assertThat(wikiModel.render("\n" + "__FORCETOC__\n" + "== -_/.:!~'() ==", false))
				.isEqualTo("" + "\n" + "\n" + "<table id=\"toc\" class=\"toc\" summary=\"Contents\">\n" + "<tr>\n"
						+ "<td>\n" + "<div id=\"toctitle\">\n" + "<h2>Contents</h2>\n" + "</div>\n" + "<ul>\n"
	...
	public void testTOC_Listener() {
		String rawWikiText = wikiModel.parseTemplates(
				"=hello world 1=\n" + "hello world 1\n" + "\n" + "==hello world 2==\n" + "hello world 2\n");
		EventListener listener = new EventListener();
		wikiModel.parseEvents(listener, rawWikiText);
		assertThat(listener.getCollectorBuffer().toString())
