...
public class TemplateFilterTest extends FilterTestSupport {
	 ...
	 */
	@Test
	public void testTemplateIssue124_001() throws Exception {
	 ...
	 */
	@Test
	public void testTemplateIssue124_002() throws Exception {
	...
	@Test
	public void testTemplate06() throws Exception {
		assertThat(wikiModel.render("start- {{ifeq|5.0|+5}} -end", false))
				.isEqualTo("\n" + "<p>start- 5.0 equals +5 -end</p>");
	}

	@Test
	public void testTemplate09() throws Exception {
		assertThat(wikiModel.render("start- {{ifeq|test|Test}} -end", false))
				.isEqualTo("\n" + "<p>start- test is not equal Test -end</p>");
	}

	@Test
	public void testTemplateCall3() throws Exception {
		assertThat(
	...
	@Test
	public void testSwitch001() throws Exception {
	...
	@Test
	public void testNonExistingTemplate01() throws Exception {
		assertThat(wikiModel.render("==Other areas of Wikipedia==\n"
				+ "{{WikipediaOther}}<!--Template:WikipediaOther-->", false)).isEqualTo(
	...
	@Test
	public void testNonExistingTemplate02() throws Exception {
	...
	private void nonExistingTemplateTestLink(String wikiText, String linkTitle, String templateName) throws Exception {
		...
		assertThat(wikiModel.render(wikiText, false)).isEqualTo("\n<p><a href=\"http://www.bliki.info/wiki/" + urlTitle
				+ "\" title=\"" + urlTitle + "\">" + linkTitle + "</a></p>");
	...
	@Test
	public void testNonExistingTemplate03() throws Exception {
		...
		nonExistingTemplateTestLink("{{:Template:Help:test123456789}}", "Template:Help:test123456789",
				"Help:test123456789");
	...
	@Test
	public void testTemplateCall1() throws Exception {
		assertThat(wikiModel.render("start-{{:Include Page}}-end", false))
				.isEqualTo("\n" + "<p>start-an include page-end</p>");
	}

	@Test
	public void testTemplateCall2() throws Exception {
		assertThat(wikiModel.render("start-{{templ1|a=3|b}}-end start-{{templ2|sdfsf|klj}}-end", false))
				.isEqualTo("\n" + "<p>start-b) First: 3 Second: b-end start-c) First: sdfsf Second: klj-end</p>");
	}

	@Test
	public void testTemplateCall4() throws Exception {
	...
	@Test
	public void testTemplateCall4a() throws Exception {
		assertThat(wikiModel.render("{{tl}}", false))
				.isEqualTo("\n" + "<p>[[:Template:[[Template:{{{1}}}|{{{1}}}]]]]</p>");
	}

	@Test
	public void testTemplateCall5() throws Exception {
	...
	@Test
	public void testTemplateImage1() throws Exception {
	...
	@Test
	public void testTemplateNowiki() throws Exception {
		assertThat(wikiModel.render("start-<nowiki>{{templ1|a=3|b}}-</noWiKi>end", false))
				.isEqualTo("\n" + "<p>start-{{templ1|a=3|b}}-end</p>");
	}

	@Test
	public void testTemplateParameter01() throws Exception {
		assertThat(wikiModel.render("start-{{Test|arg1|arg2}}-end", false))
				.isEqualTo("\n" + "<p>start-a) First: arg1 Second: arg2-end</p>");
	}

	@Test
	public void testTemplateParameter02() throws Exception {
		assertThat(wikiModel.render(
	...
	@Test
	public void testTemplateParameter03() throws Exception {
	...
	@Test
	public void testTemplate04() throws Exception {
		assertThat(wikiModel.render("{{#ifeq: A | B |A equals B |A is not equal B}}", false))
				.isEqualTo("\n" + "<p>A is not equal B</p>");
	}

	@Test
	public void testTemplate05() throws Exception {
		assertThat(wikiModel.render("start- {{ifeq|A|B}} -end", false))
				.isEqualTo("\n" + "<p>start- A is not equal B -end</p>");
	}

	@Test
	public void testTemplate07() throws Exception {
		assertThat(wikiModel.render("start- {{ifeq|5.001|+5}} -end", false))
				.isEqualTo("\n" + "<p>start- 5.001 is not equal +5 -end</p>");
	}

	@Test
	public void testTemplate08() throws Exception {
		assertThat(wikiModel.render("start- {{ifeq|test|test}} -end", false))
	...
	@Test
	public void testTemplateParameter13() throws Exception {
		assertThat(wikiModel.render("{| class=\"wikitable\"\n"
	...
	@Test
	public void testNestedIf02() throws Exception {
		assertThat(wikiModel.render(TEST_STRING_02, false))
				.isEqualTo("\n" + "<pre>an\n</pre>\n" + "<p>article on:\n" + "</p>" + "");
	}

	@Test
	public void testParserFunctionLC001() throws Exception {
		assertThat(wikiModel.render("A {{lc: Lower Case}} text", false)).isEqualTo("\n" + "<p>A lower case text</p>");
	}

	@Test
	public void testParserFunctionTag001() throws Exception {
		assertThat(wikiModel.render("{{#tag:ref|'''a simple test'''}}{{#tag:references}}", false)).isEqualTo("\n"
	...
	@Test
	public void testNavbox() throws Exception {
		assertThat(wikiModel.render(NAVBOX_STRING, false)).isEqualTo("\n"
	...
	@Test
	public void testPipe001a() throws Exception {
		assertThat(wikiModel.render("{{2x|Hello World\n" + "}}", false))
				.isEqualTo("\n" + "<p>Hello World\n" + "Hello World\n" + "</p>");
	}

	@Test
	public void testPipe001() throws Exception {
		assertThat(wikiModel.render("{{2x|hello world" + "}} ", false))
				.isEqualTo("\n" + "<p>hello worldhello world </p>");
	}

	@Test
	public void testPipe002() throws Exception {
	...
	@Test
	public void testPipe003() throws Exception {
	...
	@Test
	public void testInvalidNoinclude() throws Exception {
		assertThat(wikiModel.render("test123 start<noinclude>\n" + "test123 end", false))
				.isEqualTo("\n" + "<p>test123 start</p>");
	}

	@Test
	public void testInvalidIncludeonly() throws Exception {
		assertThat(wikiModel.render("test123 start<includeonly>\n" + "test123 end", false))
				.isEqualTo("\n" + "<p>test123 start\n" + "test123 end</p>");
	}

	@Test
	public void testInvalidOnlyinclude() throws Exception {
		assertThat(wikiModel.render("test123 start<onlyinclude>\n" + "test123 end", false))
				.isEqualTo("\n" + "<p>test123 end</p>");
	}

	@Test
	public void testIf_image_test() throws Exception {
	...
	public void testMONTHNAME() throws Exception {
		assertThat(wikiModel.render("test {{MONTHNAME | 10 }} test123", false))
				.isEqualTo("\n" + "<p>test October test123</p>");
	}

	@Test
	public void testMONTHNUMBER() throws Exception {
		assertThat(wikiModel.render("test {{MONTHNUMBER | OctoBer }} test123", false))
				.isEqualTo("\n" + "<p>test 10 test123</p>");
	}

	@Test
	public void testInfoboxProgrammiersprachen() throws Exception {
		assertThat(wikiModel.render("{{Infobox Programmiersprache" + "|Name = JavaScript"
				+ "|Beschreibung = Skriptsprache" + "|Paradigma = multiparadigmatisch" + "|Erscheinungsjahr = 1995"
				+ "|Entwickler = [[Brendan Eich]]" + "|AktuelleVersion = 1.8" + "|AktuelleVersionFreigabeDatum = 2008"
	...
	@Test
	public void testProgrammiersprachen() throws Exception {
		assertThat(wikiModel.render("=== Versionsgeschichte ===\n" + "{| class=\"wikitable\"\n"
				+ "|+Versionsgeschichte von JavaScript<ref>{{cite web|author=John Resig |url=http://ejohn.org/blog/versions-of-javascript |title=Versions of JavaScript |publisher=Ejohn.org |date= |accessdate=2009-05-19}}</ref>\n"
				+ "|-\n"
				+ "! Version !! Release !! Entsprechung !! Netscape Navigator !! Mozilla Firefox !! Internet Explorer !! Opera !! Safari !! Google Chrome \n"
	...
	@Test
	public void testIssue77_001() throws Exception {
		assertThat(wikiModel.render("{|\n" + "! | <h2 style=\"background:#cedff2;\">In the news</h2>\n" + "|-\n"
	...
	@Test
	public void testIssue77_002() throws Exception {
		assertThat(wikiModel.render(
	...
	@Test
	public void testRndfracTemplate001() throws Exception {
		assertThat(wikiModel.render("{{rndfrac|0.1234|8}}", false))
				.isEqualTo("\n" + "<p><span class=\"frac nowrap\"><sup>1</sup>⁄<sub>8</sub></span></p>");
	}

	@Test
	public void testRndfracTemplate002() throws Exception {
		assertThat(wikiModel.render("{{rndfrac|12.65|6}}", false))
				.isEqualTo("\n" + "<p><span class=\"frac nowrap\">12<sup> </sup><sup>4</sup>⁄<sub>6</sub></span></p>");
	}

	@Test
	public void testTemplateMain() throws Exception {
	...
	@Test
	public void testTemplateSeeAlso() throws Exception {
	...
	@Test
	public void testTemplateMain002() throws Exception {
		assertThat(wikiModel.render("==Demographics==\n" + "{{Main|Demographics of Pakistan|Pakistani people}}\n"
				+ "{{See also|Ethnic groups in Pakistan|Religion in Pakistan}}",
				false)).isEqualTo("<h2><span class=\"mw-headline\" id=\"Demographics\">Demographics</span></h2>\n"
						+ "<div class=\"rellink relarticle mainarticle\">Main articles: <a href=\"http://www.bliki.info/wiki/Demographics_of_Pakistan\" title=\"Demographics of Pakistan\">Demographics of Pakistan</a> and <a href=\"http://www.bliki.info/wiki/Pakistani_people\" title=\"Pakistani people\">Pakistani people</a></div>\n"
						+ "<div class=\"rellink boilerplate seealso\">See also: <a href=\"http://www.bliki.info/wiki/Ethnic_groups_in_Pakistan\" title=\"Ethnic groups in Pakistan\">Ethnic groups in Pakistan</a> and <a href=\"http://www.bliki.info/wiki/Religion_in_Pakistan\" title=\"Religion in Pakistan\">Religion in Pakistan</a></div>");
	}

	@Test
	public void testUnknownTag001() throws Exception {
	...
	@Test
	public void testTemplateNavbox() throws Exception {
	...
	@Test
	public void testTemplateNavbar() throws Exception {
		assertThat(wikiModel.render(
	...
	@Test
	public void testTemplateWithNewlines001() throws Exception {
	...
	@Test
	public void testTemplateWithHashtag001() throws Exception {
		assertThat(wikiModel.render(
	...
	public void testTransclusionInPre001() {
		assertThat(wikiModel.parseTemplates("<pre>{{:Viva_World_Cup}}</pre>"))
				.isEqualTo("<pre>{{:Viva_World_Cup}}</pre>");
	...
	@Test
	public void testPreAlmostEqualToNowiki001() throws Exception {
	...
	@Test
	public void testPreAlmostEqualToNowiki002() throws Exception {
	 ...
	 */
	@Test
	public void testLinkWithExtraHTMLTag001() throws Exception {
	 ...
	 */
	@Test
	public void testSelfRecursion001() throws Exception {
	 ...
	 */
	@Test
	public void testSelfRecursion002() throws Exception {
	...
	@Test
	public void testSelfRecursion003() throws Exception {
	...
	@Test
	public void testSelfRecursion004() throws Exception {
	...
	@Test
	public void testSelfRecursion005() {
		assertThat(wikiModel.parseTemplates("{{1x|{{1x|foo{{!}}bar}}}}")).isEqualTo("foo|bar");
	}

	@Test
	public void testSelfRecursion005a() throws Exception {
	 ...
	 */
	@Test
	public void testIndirectSelfRecursion001() throws Exception {
		// https://en.wikipedia.org/wiki/Help:Template#Nesting_templates
	 ...
	 */
	@Test
	public void testIndirectSelfRecursion002() throws Exception {
		// https://en.wikipedia.org/wiki/Help:Template#Nesting_templates
	 ...
	 */
	@Test
	public void testIndirectSelfRecursion001a() throws Exception {
		// https://en.wikipedia.org/wiki/Help:Template#Nesting_templates
	 ...
	 */
	@Test
	public void testIndirectSelfRecursion002a() throws Exception {
		// https://en.wikipedia.org/wiki/Help:Template#Nesting_templates
	...
	/**
	 * Test whether the template cache distinguishes pages from different namespaces with the same page title.
	 */
	@Test
	public void testTemplateCache001() throws Exception {
	 ...
	 */
	@Test
	public void testTemplateCache002() throws Exception {
	 ...
	 */
	@Test
	public void testTemplateCache003() throws Exception {
	 ...
	 */
	@Test
	public void testTemplateCache004() throws Exception {
	 ...
	 */
	@Test
	public void testTemplateCache005() throws Exception {
	...
	@Test
	public void testRenderURLWithSingleQuote() throws Exception {
		assertThat(wikiModel.render("[http://url.com/with'singlequotes foo]").trim()).isEqualTo(
				"<p><a class=\"external text\" href=\"http://url.com/with&#39;singlequotes\" rel=\"nofollow\">foo</a></p>");
	}

	@Test
	public void testRenderDlDd() throws Exception {
		assertThat(wikiModel.render("<dl><dd>Foo</dd></dl>").trim()).isEqualTo("<dl><dd>Foo</dd></dl>");
	}

	@Test
	public void testRenderRuby() throws Exception {
		assertThat(wikiModel.render("<ruby><rp>(</rp><rt>Foo</rt></ruby>").trim())
				.isEqualTo("<p><ruby><rp>(</rp><rt>Foo</rt></ruby></p>");
	}

	@Test
	public void testRenderQ() throws Exception {
