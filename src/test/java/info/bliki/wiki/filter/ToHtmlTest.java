...
public class ToHtmlTest extends FilterTestSupport {
	...
	public void test003() {
		...
		assertThat(WikiModel.toHtml("start <includeonly> test </includeonly> end"))
	...
	public void test004() throws Exception {
		...
		// step
		WikiModel.toText(model, new HTMLConverter(), "start <includeonly> test </includeonly> end", writer, false,
				true);
		writer.flush();
		assertThat(writer.toString()).isEqualTo("\n" + "<p>start  test  end</p>");
	}
