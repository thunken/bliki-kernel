...
public class WPImageFilterTest extends FilterTestSupport {
	...
	public void testEncoder002() {
		assertThat(Encoder.encodeTitleLocalUrl("/hello/you.this.is..an../exa..mple.html"))
				.isEqualTo("/hello/you'2Ethis'2Eis'2E'2Ean'2E'2E/exa..mple.html");
	}

	@Test
	public void testImage00() throws Exception {
	...
	@Test
	public void testImage01b() throws Exception {
		assertThat(wikiModel.render("[[Image:baby_elephant.jpg|thumb|Link to the [[Sandbox]] caption]]", false))
				.isEqualTo("\n" + "<div class=\"thumb tright\">\n"
	...
	@Test
	public void testImage02() throws Exception {
	...
	@Test
	public void testImage03() throws Exception {
	...
	@Test
	public void testImage04() throws Exception {
	...
	@Test
	public void testImage06() throws Exception {
		assertThat(wikiModel.render(
	...
	@Test
	public void testImage07() throws Exception {
	...
	@Test
	public void testImage08() throws Exception {
	...
	@Test
	public void testImage09() throws Exception {
		assertThat(wikiModel.render("[[Image:Example.png|150px|link=Main Page\n" + "|alt=Alt text|Title text]]", false))
				.isEqualTo("\n"
	...
	@Test
	public void testImage10() throws Exception {
		assertThat(wikiModel.render("[[Bild:Example.png|150px|link=Main Page|thumb|alt=Alt text|Caption]]", false))
				.isEqualTo("\n" + "<div class=\"thumb tright\">\n"
	...
	@Test
	public void testImage11() throws Exception {
		assertThat(wikiModel.render("[[Bild:Example.png|150px|link=|thumb|alt=Alt text|Caption]]", false))
				.isEqualTo("\n" + "<div class=\"thumb tright\">\n"
	...
	@Test
	public void testImage12() throws Exception {
		assertThat(wikiModel.render(
				"these are the [[Image:FIFA WM 2006 Teams.png|thumb|220x100px|Qualifying countries]]...", false))
						.isEqualTo("\n" + "<p>these are the </p>\n" + "<div class=\"thumb tright\">\n"
	...
	@Test
	public void testImage13() throws Exception {
		assertThat(wikiModel
	...
	@Test
	public void testImage15() throws Exception {
		String raw = "[[Image:Bamfield (171).jpg|right|thumb"
				+ "|Tsunami hazard sign at [[Bamfield]], [[British Columbia]]" + "|alt=Photo of sign reading "
				+ "\"Tsunami Hazard Zone...In case of earthquake," + " go to higher ground or inland\"]]";
		String expected = "\n" + "<div class=\"thumb tright\">\n"
	...
	@Test
	public void testImage16() throws Exception {
	...
	@Test
	public void testImage17() throws Exception {
		assertThat(Encoder.encodeTitleLocalUrl("Test & ToDo.jpg")).isEqualTo("Test_'26_ToDo.jpg");
		assertThat(wikiModel.render("[[File:Test 4711.jpg|thumb|left|150px|Test 4711]]", false)).isEqualTo("\n"
				+ "<div class=\"thumb tleft\">\n"
	...
	@Test
	public void testImage19() throws Exception {
	...
	@Test
	public void testImage18() throws Exception {
