...
public class WPLinkFilterTest extends FilterTestSupport {
	...
	public void testIssue136() throws Exception {
		assertThat(wikiModel.render("[[Test:http://somesite.org]]", false)).isEqualTo("\n"
				+ "<p><a href=\"http://www.bliki.info/wiki/Test:http://somesite.org\" title=\"Test:http://somesite.org\">Test:http://somesite.org</a></p>");
	}

	@Test
	public void testLinkHash() throws Exception {
		assertThat(wikiModel.render("##[[Using Eclipse Wikipedia Editor:Getting Started#Features|Features]]", false))
				.isEqualTo("\n" + "<ol>\n" + "<li>\n" + "<ol>\n"
	...
	@Test
	public void testLink0() throws Exception {
	...
	public void testLink2() throws Exception {
		assertThat(wikiModel.render("[[Test|Test]]", false))
	...
	@Test
	public void testLinkToCategoryPage() throws Exception {
	...
	@Test
	public void testLinkWithSuffixAtEOF() throws Exception {
		assertThat(wikiModel.render("[[Test]]xx", false))
				.isEqualTo("\n" + "<p><a href=\"http://www.bliki.info/wiki/Test\" title=\"Test\">Testxx</a></p>");
	}

	@Test
	public void testLinkWithSuffix() throws Exception {
		assertThat(wikiModel.render("[[Test]]xx ", false))
				.isEqualTo("\n" + "<p><a href=\"http://www.bliki.info/wiki/Test\" title=\"Test\">Testxx</a> </p>");
	}
	...
	@Test
	public void testLink10() throws Exception {
	...
	@Test
	public void testLink11() throws Exception {
	...
	@Test
	public void testLink14() throws Exception {
		assertThat(wikiModel.render(
				"Dolphins are [[aquatic mammal]]s that are closely related to [[whale]]s and [[porpoise]]s.", false))
						.isEqualTo("\n"
	...
	@Test
	public void testLink15() throws Exception {
	...
	@Test
	public void testLink16() throws Exception {
		assertThat(wikiModel.render("[[main  Page]]", false)).isEqualTo(
				"\n<p><a href=\"http://www.bliki.info/wiki/Main_Page\" title=\"Main Page\">main  Page</a></p>");
	}

	@Test
	public void testLink17() throws Exception {
	...
	@Test
	public void testLink18() throws Exception {
	...
	@Test
	public void testInterwiki2() throws Exception {
		assertThat(wikiModel.render("[[intra:page/directory|Page directory]]", false))
	...
	@Test
	public void testSectionLink01() throws Exception {
		assertThat(wikiModel.render("[[#Section Link|A Section Link]]", false))
				.isEqualTo("\n" + "<p><a href=\"#Section_Link\">A Section Link</a></p>");
	}

	@Test
	public void testSectionLink02() throws Exception {
		assertThat(wikiModel.render("[[#Sectionäöü]]", false))
	 ...
	 */
	@Test
	public void testSectionLink03() throws Exception {
		assertThat(wikiModel.render("[[#Section Link]]", false))
				.isEqualTo("\n" + "<p><a href=\"#Section_Link\">#Section Link</a></p>");
	}

	@Test
	public void testSpecialLink01() throws Exception {
	...
	@Test
	public void testSubLink01() throws Exception {
	...
	//
	@Test
	public void testSubLink04() throws Exception {
	...
	@Test
	public void testRedirect05() throws Exception {
	...
	@Test
	public void testPlainTextConverter001() throws Exception {
		assertThat(wikiModel.render(new PlainTextConverter(), "An [http://www.example.com external link]. ", false))
				.isEqualTo("\n" + "An external link. ");
	}
	...
	public void testPlainTextConverter002() throws Exception {
		...
		assertThat(wikiModel.render(new PlainTextConverter(), wikitext, false))
	...
	@Test
	public void testCaseSensitiveLinking() throws Exception {
		wikiModel = new WikiModel(new Configuration(DEFAULT_WIKI_ID, CaseSensitive), "${image}", "${title}");
