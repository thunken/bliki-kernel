...
public class WPListFilterTest extends FilterTestSupport {
	...
	@Test
	public void testWPList01() throws Exception {
		String testString = "\n*#: a nested list\n";
	...
	@Test
	public void testWPList02() throws Exception {
		String testString = "\n*#; a nested list 1\n*#: a nested list 2\n";
		...
		assertThat(wikiModel.render(testString, false))
				.isEqualTo("\n" + "\n" + "<ul>\n" + "<li>\n" + "<ol>\n" + "<li>\n" + "<dl>\n"
	...
	public void testList2() throws Exception {
		assertThat(wikiModel.render(LIST2, false))
				.isEqualTo("\n" + "<ol>\n" + "<li>first\n" + "<ol>\n" + "<li>second</li>\n</ol></li>\n</ol>");
	}
	...
	public void testList4() throws Exception {
		assertThat(wikiModel.render(LIST4, false))
				.isEqualTo("\n" + "<ol>\n" + "<li>first</li>\n" + "<li>second</li>\n</ol>");
	}

	@Test
	public void testList4A() throws Exception {
		assertThat(wikiModel.render(LIST4A, false))
				.isEqualTo("\n" + "<ol>\n" + "<li>first</li>\n" + "<li>second</li>\n</ol>");
	}

	@Test
	public void testList4B() throws Exception {
		assertThat(wikiModel.render(LIST4B, false))
				.isEqualTo("\n" + "<ol>\n" + "<li>first</li>\n" + "<li>second</li>\n</ol>");
	}

	@Test
	public void testList4C() throws Exception {
		assertThat(wikiModel.render(LIST4C, false)).isEqualTo("\n" + "<ol>\n" + "<li>first</li>\n</ol>");
	}

	@Test
	public void testList10() throws Exception {
		assertThat(wikiModel.render("*a simple test<nowiki>\n" + "x+y\n" + "</nowiki>\n" + "test test", false))
				.isEqualTo("\n" + "<ul>\n" + "<li>a simple test\n" + "x+y\n" + "</li>\n</ul>\n" + "<p>test test</p>");
	}

	@Test
	public void testList11() throws Exception {
		assertThat(wikiModel.render("*a simple test <nowiki>blabla\n" + "x+y\n" + "test test", false))
	...
	public void testList13() throws Exception {
		assertThat(wikiModel.render(new PlainTextConverter(), LIST3, false)).isEqualTo(
				"\n" + "test 1\n" + "test 2\n" + "test 3\n" + "\n" + "hello\n" + "\n" + "\n" + "test 4\n" + "");
	}
	...
	@Test
	public void testListContinuation01() throws Exception {
		assertThat(wikiModel.render(": <span>simple definition</span>", false))
				.isEqualTo("\n" + "<dl>\n" + "<dd><span>simple definition</span></dd>\n</dl>");
	}

	@Test
	public void testListContinuation02() throws Exception {
		assertThat(wikiModel.render(LIST_CONTINUATION, false))
	...
	@Test
	public void testListContinuation03() throws Exception {
	...
	@Test
	public void testListContinuation04() throws Exception {
		assertThat(wikiModel.render("\n" + "; definition list 1\n" + "; definition list 2\n" + ": definition list 3\n"
	...
	@Test
	public void testListContinuation05() throws Exception {
	...
	@Test
	public void testListContinuation06() throws Exception {
