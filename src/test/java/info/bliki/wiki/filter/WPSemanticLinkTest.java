...
public class WPSemanticLinkTest extends FilterTestSupport {
	 ...
	 */
	@Test
	public void testLink01() throws Exception {
	 ...
	 */
	@Test
	public void testLink02() throws Exception {

		assertThat(wikiModel.render("The population is [[Has population:=3,993,933]].", false))
	...
	@Test
	public void testLink03() throws Exception {

		assertThat(wikiModel.render("Make [[example relation::link|alternate text]] appear in place of the link.",
				false)).isEqualTo("\n"
	...
	@Test
	public void testLink04() throws Exception {

		assertThat(wikiModel.render("To hide the property [[    example relation::link   | ]] from appearing at all",
	...
	@Test
	public void testLink05() throws Exception {

		assertThat(wikiModel.render("The [[:C++ :: operator]].", false)).isEqualTo("\n"
