...
public class WPTableFilterTest extends FilterTestSupport {
	...
	@Test
	public void testNestedTable1() throws Exception {
	...
	@Test
	public void testNestedTable2() throws Exception {
	...
	@Test
	public void testBlockquoteTable01() throws Exception {
		assertThat(wikiModel.render(TEST3, false))
				.isEqualTo("<h3><span class=\"mw-headline\" id=\"Simple_example\">Simple example</span></h3>\n"
	...
	@Test
	public void testBlockquoteTable02() throws Exception {
		assertThat(wikiModel.render("<table><tr> \n" + "<td></td>\n\n</tr>\n</table>\n", false)).isEqualTo("\n"
				+ "<table>\n" + "\n" + "<tr>\n" + " \n" + "\n" + "\n" + "\n" + "</tr>\n" + "\n" + "</table>\n" + "");
	}

	@Test
	public void testBlockquoteTable03() throws Exception {
	...
	@Test
	public void testBlockquoteTable04() throws Exception {
	...
	@Test
	public void testBlockquoteTable05() throws Exception {
	...
	@Test
	public void testBlockquoteTable06() throws Exception {
		assertThat(wikiModel.render("<table align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"3\">\n"
				+ "   <tr>\n" + "      <td>1</td>\n" + "      <td>2</td>\n" + "   </tr> \n" + "   <tr>\n"
				+ "      <td>3</td> \n" + "      <td>4</td> \n" + "   </tr>\n" + "</table>\n", false)).isEqualTo(
	...
	@Test
	public void testMathTable1() throws Exception {
		assertThat(wikiModel.render(
	...
	public void testAll() throws Exception {
		...
		assertThat(wikiModel.render("{| class=\"wikitable\" style=\"text-align:left\"\n"
	...
	@Test
	public void testTHTableMix001() throws Exception {
		assertThat(wikiModel.render(
	...
	@Test
	public void testEmptyCellTable() throws Exception {
		assertThat(
	...
	@Test
	public void testBlockquoteTableText01() throws Exception {
	...
	@Test
	public void testWPTableText01() throws Exception {
	...
	@Test
	public void testUmlauts01() throws Exception {
		assertThat(wikiModel.render(new PlainTextConverter(), "Eine große''' <del>Überraschung</del>", false))
				.isEqualTo("\n" + "Eine große Überraschung");
	}

	@Test
	public void testTableCross() throws Exception {
