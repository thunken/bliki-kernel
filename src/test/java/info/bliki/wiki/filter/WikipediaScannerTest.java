...
public class WikipediaScannerTest {
	...
	@Test
	public void testFindNestedTemplateEndSimpleTemplate() throws Exception {
		String input = "foo {{template|parameter|another}}123";
		assertThat(findEnd(input, 6)).isEqualTo(input.length() - 3);
	}

	@Test
	public void testFindNestedTemplateEndNoEndReturnsMinusOne() throws Exception {
		String input = "foo {{template|parameter|another";
		assertThat(findEnd(input, 6)).isEqualTo(-1);
	}

	@Test
	public void testFindNestedTemplateEndWithNestedTemplate() throws Exception {
		String input = "foo {{template|{{nested}}|another}}123";
		assertThat(findEnd(input, 6)).isEqualTo(input.length() - 3);
	}

	@Test
	public void testFindNestedTemplateEndWithCurlyBracesAsParameters() throws Exception {
		String input = "foo {{template|{|another}}123";
		assertThat(findEnd(input, 6)).isEqualTo(input.length() - 3);
	}

	@Test
	public void testFindNestedTemplateEndWithCurlyBracesAsParameters2() throws Exception {
		String input = "foo {{template|}|another}}123";
		assertThat(findEnd(input, 6)).isEqualTo(input.length() - 3);
	}

	@Test
	public void testFindNestedTemplateEndWithTripleCurlyBracesAsParameters() throws Exception {
	...
	@Test
	public void testWithUnsupportedTemplate() throws Exception {
		String input = "#switch: } \n"
