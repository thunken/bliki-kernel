...
public class NamespaceTest {
	...
	@Test
	public void testDraftNamespace() {
	...
	@Test
	public void testEducationProgramNamespace() {
	...
	@Test
	public void testTimedTextNamespace() {
	...
	@Test
	public void testTopicNamespace() {
		assertThat(namespace.getNamespace("Topic")).isEqualTo(namespace.TOPIC);
	}

	@Test
	public void testCanonicalNamespace() throws Exception {
