...
public class TemplateFunctionsTest {
	...
	public void setUp() throws Exception {
		wikiModel = new ParserFunctionModel("http://www.bliki.info/wiki/${image}",
	...
	public void testIferror01() {
		assertThat(wikiModel.parseTemplates("{{#iferror: {{#expr: 1 + 2 }} | error | correct }}", false))
				.isEqualTo("correct");
	}

	@Test
	public void testIferror02() {
		assertThat(wikiModel.parseTemplates("{{#iferror: {{#expr: 1 + X }} | error | correct }}", false))
				.isEqualTo("error");
	}
	...
	public void testIfEq06() {
		...
		assertThat(wikiModel.parseTemplates("{{ #ifeq: {{{x| }}} | {{{x|u}}} | defined | undefined }}", false))
				.isEqualTo("undefined");
	}
	...
	public void testIfEq07() {
		...
		assertThat(wikiModel.parseTemplates("{{ #ifeq: {{{x}}} | {{concat| {|{|{x}|}|} }} | 1 | 0 }}", false))
				.isEqualTo("1");
	}
	...
	/**
	 * Test from <a href= "https://meta.wikimedia.org/wiki/Help:Calculation#Operators.2C_numbers.2C_and_constants"
