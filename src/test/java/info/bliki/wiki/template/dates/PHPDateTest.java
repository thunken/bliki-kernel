...
public class PHPDateTest {
	...
	@Test
	public void testWeekNumberingYear() {
		assertThat(phpDate.format("o", referenceDate)).isEqualTo("2018");
	}

	@Test
	public void testFullNumericYear() {
	...
	@Test
	public void testLowerCaseAMPM() {
		assertThat(phpDate.format("a", referenceDate)).isEqualTo("am");
	}

	@Test
	public void testUpperCaseAMPM() {
		assertThat(phpDate.format("A", referenceDate)).isEqualTo("AM");
	}

	@Test
	public void testTwelveHourFormatWithoutLeadingZeros() {
		assertThat(phpDate.format("g", referenceDate)).isEqualTo("1");
	}

	@Test
	public void testTwentyFourHourFormatWithoutLeadingZeros() {
		assertThat(phpDate.format("G", referenceDate)).isEqualTo("1");
	}

	@Test
	public void testTwelveHourFormatWithLeadingZeros() {
		assertThat(phpDate.format("h", referenceDate)).isEqualTo("01");
	}

	@Test
	public void testTwentyFourHourFormatWithLeadingZeros() {
		assertThat(phpDate.format("H", referenceDate)).isEqualTo("01");
	}

	@Test
	public void testMinutesWithLeadingZeros() {
		assertThat(phpDate.format("i", referenceDate)).isEqualTo("06");
	}

	@Test
	public void testSecondsWithLeadingZeros() {
	...
	@Test
	public void testSecondsSinceUnixEpoch() {
